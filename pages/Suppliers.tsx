...
const Suppliers: React.FC<SuppliersProps> = ({ suppliers, onSave, purchaseInvoices }) => {
                            ...
                            {filteredSuppliers.map(supplier => {
                                ...
                                return (
                                    <tr key={supplier.id}>
                                        ...
                                        <td style={{fontWeight: 600, color: 'var(--primary-color)'}}>{totalPurchases.toLocaleString()} د.ك</td>

...
// Purchases Report
// FIX: Added 'suppliers' to props to correctly look up supplier names.
                        ...
                        <tbody>
                             {filteredPurchases.map(p => (
                                <tr key={p.id}>
                                    ...
                                    {/* FIX: Use supplierId to find the supplier name from the suppliers list. */}
                                    <td>{suppliers.find(s => s.id === p.supplierId)?.name || 'Unknown'}</td>
...
// Summary Report
// FIX: Added 'suppliers' to the Omit list to match the updated ReportsProps.
